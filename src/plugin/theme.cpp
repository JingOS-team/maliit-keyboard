...
{
    return colorByName("charKeyPressedColor", QColor("#EDEEEE"));
}

QColor Theme::fontColor() const
{
    return colorByName("fontColor", QColor("#000000"));
}

QColor Theme::actionKeyColor() const
{
    return colorByName("actionKeyColor", QColor("#C4C7CD"));
}

QColor Theme::actionKeyPressedColor() const
{
    return colorByName("actionKeyPressedColor", QColor("#BABCC3"));
}
